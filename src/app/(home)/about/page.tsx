		...
		<div>
			<div
				...
				<div className="flex flex-col items-center justify-center gap-2">
					<h1 className="font-bold text-8xl font-keleti text-white">
						Welcome to Valley
						<span className="text-red-500">404</span>
					</h1>
					<p className="[background:linear-gradient(45deg,#f31260,theme(colors.slate.800)_50%,#172033)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.slate.600/.48)_80%,_theme(colors.indigo.500)_86%,_theme(colors.indigo.300)_90%,_theme(colors.indigo.500)_94%,_theme(colors.slate.600/.48))_border-box] rounded-2xl border border-transparent animate-border px-4 py-2 text-xl font-medium text-light">
