	...
	return (
		<div className="flex flex-col">
			<div className="flex items-center justify-center text-center font-keleti">
				<h2 className="font-medium text-5xl text-center text-black dark:text-white">Keymap types</h2>
			</div>

			<div className="flex flex-col gap-12 mt-8">
				<h2 className="font-medium text-3xl text-center text-black dark:text-white">Navigation</h2>
				<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 2xl:grid-cols-8 gap-5 cursor-help">
					{keymapNavigationArray.map((item) => (
						<div
							...
							<p className="text-2xl font-bold bg-[#535151] dark:bg-[#2a2828] border border-[#3e3c3c] px-2 text-white dark:text-white rounded-full">
								{item.key}
							</p>
